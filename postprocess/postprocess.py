...
baseline = 'predict.files_baseline'
baseline_self = 'predict.files_baseline_self'
baseline_swish = 'predict.files_baseline_swish'
baseline_dev = 'predict.files_baseline_and_dev'
...
for baseline_file in baseline_files:
    ...
    for i, bl_prob in enumerate(baseline_list):
        ...
        if err2 / err1 > 10:
            num += 1
        total_num += 1
        merge_prob = 0.8 * float(bl_prob) + 0.1 * bl_self_prob  + 0.05 * bl_swish_prob + 0.05 * bl_dev_prob
